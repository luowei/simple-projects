package com.ttpod.common.view.manageInfo;
...
import com.ttpod.common.tool.Controler.PhoneUtils;
...
public class PhoneManageControl extends BaseController
{
	...
	public void delete(@PathVariable int id, HttpServletRequest request,
			HttpServletResponse response) {
		Phone phone=this.phoneManageService.findById(id);
		String realPhoneImg=request.getRealPath(phone.getPhoneImage().replace("/ttpod",""));
