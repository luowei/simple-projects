				...
				<TR>
					<TD colspan="3"
						...
						<form name="form1" id="form1" method="post"
							action="${ctx }/manage/action/update.do">
							<table width="591" height="433" border="0" align="center">
								<tr>
									<td colspan="3">
										<div align="center">
											<span class="STYLE2">修改权限</span>
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td width="120">
										<input type="text" id="actionName" name="actionName"
											style="width: 120px" value="${action.actionName }" />
								...
								<tr>
									...
									<td width="212">
										<input type="text" id="orders" name="orders"
											style="width: 120px" value="${action.orders }" />
								  </td>
									<td width="289">
									...
									<td width="120">
										<select name="moduleId" id="moduleId">
											<c:forEach items="${moduleList}" var="module" varStatus="s">
												...
												<c:if test="${module.id==action.module.id}">  selected  </c:if>
								...
								<tr>
									<td width="76" align="right">
										权限路径:									</td>
									<td width="212">
										<textarea name="path" cols="200" rows="5" id="path" style="width: 200px">${action.path }</textarea>
								  </td>
									<td width="289">
