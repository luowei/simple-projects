...
<table>
	<tr>
		...
		<a href="${ctx }/manage/verifyPhonebrand/clearAll/2.do">清空</a>
	</tr>
	<tr>
...
<c:forEach items="${phonebrandList}" var="phonebrand" varStatus="s">
  <tr>
	...
	<td><font color="red">审核不通过</font></td>
	<td>${phonebrand.brandAddDate}</td>
	<td>
		<a class=cmdField href="${ctx }/manage/verifyPhonebrand/alterUnpassPhonebrand${phonebrand.id}.do">编辑</a>
    </td>
  </tr>
  </c:forEach>
</table>
