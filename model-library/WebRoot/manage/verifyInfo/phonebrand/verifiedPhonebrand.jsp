...
<table>
	<tr>
		...
		<a href="${ctx }/manage/verifyPhonebrand/clearAll/3.do">清空</a>
	</tr>
	<tr>
...
<c:forEach items="${phonebrandList}" var="phonebrand" varStatus="s">
  <tr>
	...
	<td>
		<c:if test="${phonebrand.brandStatus==1}"><font color="green">审核未通过</font></c:if>
		<c:if test="${phonebrand.brandStatus==2}"><font color="red">审核通过</font></c:if>
	</td>
