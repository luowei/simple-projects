<!--
document.write("<div id=meizzCalendarLayer style='filter:Alpha(Opacity=90); position: absolute; z-index: 9999; width: 144px; height: 193px; display: none'>");
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.darkColor  = "#F48622";    //控件的暗色/
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "#FFF5DC";    //控件的按钮背景色/
    this.wordColor  = "#A72402";    //控件的文字颜色/
    this.wordDark   = "#FFBB77";    //控件的暗文字颜色/
    this.dayBgColor = "#FFFFF4";    //日期数字背景色*
    this.todayColor = "#CC0000";    //今天在日历上的标示背景色/
    this.DarkBorder = "#FFB872";    //日期显示的立体表达色
...
function IsDate(Date_String , Dilimeter) 
{ 
  if (Date_String==null) return false; 
  DateString=Date_String.replace(/\//gi,'-');
