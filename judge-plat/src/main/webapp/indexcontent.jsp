...
<a href=""><img class="logo" src="${ctx}/images/logo.jpg" alt="石化产品现货估价平台"/></a>
...
<div class="m_left">
    ...
    <div class="text01">
        <strong>隆众估价的作用</strong>

        <p>1、隆众估价为市场交易提供准确、客观并及时的第三方交易参考价格，作为第三方价格参与市场交易，减少不正常价格波动给交易各方造成的影响。另外可为远期交易提供第三方的价格参考。</p>

        <p>2、作为研究和评估市场的基础数据，为石化企业、期货公司及相关管理部门跟踪、分析或制订政策法规提供依据。</p>
    </div>
...
<div class="m_center">
    ...
    <div id="lib_Tab2">
        ...
        <div class="lib_Contentbox lib_tabborder">
            <div id="con_two_1"><a href="http://www.oilchem.net/chart/pricechart.shtml?index=1&showexp=1"
                                   target="_blank"><img
                    src="http://www.lzicp.com/chart/pricechart1.shtml?Button1=%E7%BB%98%E5%9B%BE&Button1=%E5%88%B7%E6%96%B0&index=1&showexp=1&kType=0&lb=1&lbid=1&cpmc=&cplb=&ggxh=&scqy=&jldw=&jldw2=&cPrice=hdind&mPrice=&dq=&qxh=&jglx=&jglx2=&bjsc=&sid=&TimeRange=6&startdate=2011/1/23&enddate=2013/1/22&ChartSize=bk&ChartType=1&MajorVGrid=1&HGrid=1&style=0&avgType1=None&movAvg1=10&avgType2=None&movAvg2=20&avgType3=None&movAvg3=50&Indicator1=None&Indicator2=None&Indicator3=None&Indicator4=None&Band=None&Button1=%E7%BB%98%E5%9B%BE&"
                    alt="原油价格指数曲线图"/></a></div>
            <div id="con_two_2" style="display:none"><a
                    href="http://www.oilchem.net/chart/pricechart.shtml?index=7&showexp=1" target="_blank"><img
                    src="http://www.lzicp.com/chart/pricechart1.shtml?Button1=%E7%BB%98%E5%9B%BE&Button1=%E5%88%B7%E6%96%B0&index=7&showexp=1&kType=0&lb=1&lbid=1&cpmc=&cplb=&ggxh=&scqy=&jldw=&jldw2=&cPrice=hdind&mPrice=&dq=&qxh=&jglx=&jglx2=&bjsc=&sid=&TimeRange=6&startdate=2011/1/23&enddate=2013/1/22&ChartSize=bk&ChartType=1&MajorVGrid=1&HGrid=1&style=0&avgType1=None&movAvg1=10&avgType2=None&movAvg2=20&avgType3=None&movAvg3=50&Indicator1=None&Indicator2=None&Indicator3=None&Indicator4=None&Band=None&Button1=%E7%BB%98%E5%9B%BE&"
                    alt="汽油价格指数曲线图"/></a></div>
            <div id="con_two_3" style="display:none"><a
                    href="http://www.oilchem.net/chart/pricechart.shtml?index=8&showexp=1" target="_blank"><img
                    src="http://www.lzicp.com/chart/pricechart1.shtml?Button1=%E7%BB%98%E5%9B%BE&Button1=%E5%88%B7%E6%96%B0&index=8&showexp=1&kType=0&lb=1&lbid=1&cpmc=&cplb=&ggxh=&scqy=&jldw=&jldw2=&cPrice=hdind&mPrice=&dq=&qxh=&jglx=&jglx2=&bjsc=&sid=&TimeRange=6&startdate=2011/1/23&enddate=2013/1/22&ChartSize=bk&ChartType=1&MajorVGrid=1&HGrid=1&style=0&avgType1=None&movAvg1=10&avgType2=None&movAvg2=20&avgType3=None&movAvg3=50&Indicator1=None&Indicator2=None&Indicator3=None&Indicator4=None&Band=None&Button1=%E7%BB%98%E5%9B%BE&"
                    alt="柴油价格指数曲线图"/></a></div>
            <div id="con_two_4" style="display:none"><a
                    href="http://www.oilchem.net/chart/pricechart.shtml?index=4&showexp=1" target="_blank"><img
                    src="http://www.lzicp.com/chart/pricechart1.shtml?Button1=%E7%BB%98%E5%9B%BE&Button1=%E5%88%B7%E6%96%B0&index=4&showexp=1&kType=0&lb=1&lbid=1&cpmc=&cplb=&ggxh=&scqy=&jldw=&jldw2=&cPrice=hdind&mPrice=&dq=&qxh=&jglx=&jglx2=&bjsc=&sid=&TimeRange=6&startdate=2011/1/23&enddate=2013/1/22&ChartSize=bk&ChartType=1&MajorVGrid=1&HGrid=1&style=0&avgType1=None&movAvg1=10&avgType2=None&movAvg2=20&avgType3=None&movAvg3=50&Indicator1=None&Indicator2=None&Indicator3=None&Indicator4=None&Band=None&Button1=%E7%BB%98%E5%9B%BE&"
                    alt="橡胶价格指数曲线图"/></a></div>
            <div id="con_two_5" style="display:none"><a
                    href="http://www.oilchem.net/chart/pricechart.shtml?index=9&showexp=1" target="_blank"><img
                    src="http://www.lzicp.com/chart/pricechart1.shtml?Button1=%E7%BB%98%E5%9B%BE&Button1=%E5%88%B7%E6%96%B0&index=9&showexp=1&kType=0&lb=1&lbid=1&cpmc=&cplb=&ggxh=&scqy=&jldw=&jldw2=&cPrice=hdind&mPrice=&dq=&qxh=&jglx=&jglx2=&bjsc=&sid=&TimeRange=6&startdate=2011/1/23&enddate=2013/1/22&ChartSize=bk&ChartType=1&MajorVGrid=1&HGrid=1&style=0&avgType1=None&movAvg1=10&avgType2=None&movAvg2=20&avgType3=None&movAvg3=50&Indicator1=None&Indicator2=None&Indicator3=None&Indicator4=None&Band=None&Button1=%E7%BB%98%E5%9B%BE&"
                    alt="丁苯橡胶价格指数曲线图"/></a></div>
            <div id="con_two_6" style="display:none"><a
                    href="http://www.oilchem.net/chart/pricechart.shtml?index=10&showexp=1" target="_blank"><img
                    src="http://www.lzicp.com/chart/pricechart1.shtml?Button1=%E7%BB%98%E5%9B%BE&Button1=%E5%88%B7%E6%96%B0&index=10&showexp=1&kType=0&lb=1&lbid=1&cpmc=&cplb=&ggxh=&scqy=&jldw=&jldw2=&cPrice=hdind&mPrice=&dq=&qxh=&jglx=&jglx2=&bjsc=&sid=&TimeRange=6&startdate=2011/1/23&enddate=2013/1/22&ChartSize=bk&ChartType=1&MajorVGrid=1&HGrid=1&style=0&avgType1=None&movAvg1=10&avgType2=None&movAvg2=20&avgType3=None&movAvg3=50&Indicator1=None&Indicator2=None&Indicator3=None&Indicator4=None&Band=None&Button1=%E7%BB%98%E5%9B%BE&"
...
<div class="m_right">
    ...
    <div class="ads01">
        <a href="#" target="_blank"><img src="images/ads02.jpg" alt="隆众石化网大宗商品数据云终端"/></a>
    </div>

    <div class="ads02">
        <a href="http://news.oilchem.net/2012/zt/" target="_blank"><img src="images/ads03.jpg" alt="隆众专题"/></a>
    </div>
    <div class="box_comm" style="height:298px;">
        <h2><a href="http://price.oilchem.net/getDdfListIndex.lz" id="TitY0" onmouseover="MenuY(0)" class="on"
