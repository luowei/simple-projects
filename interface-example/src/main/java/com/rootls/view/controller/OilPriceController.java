...
import com.rootls.dao.mapper.IBOPriceExtractor;
import com.rootls.dao.mapper.IBOPriceMapper;
...
public class OilPriceController extends BaseController{
    ...
    public RetBean<IBOPrice> getOne(Model model, IBOPrice oilPrice, User user){
        if (user.getStartDate() == null) {
            return new RetBean<IBOPrice>(Config.FAILD_RET_CODE, Config.NODATA_RET_MSG);
        }
    ...
    public RetBean<List<IBOPrice>> getList(Model model, IBOPrice oilPrice, User user,IArgDto iArgDto){
        if (user.getStartDate() == null) {
            return new RetBean<List<IBOPrice>>(Config.FAILD_RET_CODE, Config.NODATA_RET_MSG);
        }
